...
#             # ...
#             confirmation = EmailConfirmation.create(email_address=email_obj)
#             confirmation.send(request=request)  # ✅ Fixes the ImproperlyConfigured error
...
def profile_emailchange(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # ✅ Send confirmation using HMAC
            confirmation = EmailConfirmationHMAC(email_obj)
...
def profile_emailverify(request):
    ...
    messages.success(request, 'Confirmation email re-sent.')
    return redirect('profile-settings')
